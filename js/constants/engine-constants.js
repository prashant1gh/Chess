...
const BOARD_SQUARE_NUMBERS = 120;
...
const BIG_PIECES = [BOOL.FALSE, BOOL.FALSE, BOOL.TRUE, BOOL.TRUE, BOOL.TRUE, BOOL.TRUE, BOOL.TRUE, BOOL.FALSE, BOOL.TRUE, BOOL.TRUE, BOOL.TRUE, BOOL.TRUE, BOOL.TRUE];
const MAJOR_PIECES = [BOOL.FALSE, BOOL.FALSE, BOOL.FALSE, BOOL.FALSE, BOOL.TRUE, BOOL.TRUE, BOOL.TRUE, BOOL.FALSE, BOOL.FALSE, BOOL.FALSE, BOOL.TRUE, BOOL.TRUE, BOOL.TRUE];
const MINOR_PIECES = [BOOL.FALSE, BOOL.FALSE, BOOL.TRUE, BOOL.TRUE, BOOL.FALSE, BOOL.FALSE, BOOL.FALSE, BOOL.FALSE, BOOL.TRUE, BOOL.TRUE, BOOL.FALSE, BOOL.FALSE, BOOL.FALSE];
...
const NUMBER_OF_DIRECTION = [0, 0, 8, 4, 4, 8, 8, 0, 8, 4, 4, 8, 8];
const PIECE_DIRECTIONS = [0, 0, KNIGHT_DIRECTION, BISHOP_DIRECTION, ROOK_DIRECTION, KING_DIRECTION, KING_DIRECTION, 0, KNIGHT_DIRECTION, BISHOP_DIRECTION, ROOK_DIRECTION, KING_DIRECTION, KING_DIRECTION];
const LOOP_NON_SLIDE_PIECES = [PIECES.wN, PIECES.wK, 0, PIECES.bN, PIECES.bK, 0];
const LOOP_NON_SLIDE_INDEX = [0, 3];
const LOOP_SLIDE_PIECES = [PIECES.wB, PIECES.wR, PIECES.wQ, 0, PIECES.bB, PIECES.bR, PIECES.bQ, 0];
